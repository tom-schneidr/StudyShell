    ...
    <div className="h-full flex flex-col bg-shell-bg overflow-hidden p-8">
      ...
      <div className="flex-1 flex flex-col items-center justify-center gap-6 max-w-4xl mx-auto w-full">
        <div className="flex flex-col items-center gap-2 mb-4">
          <div
            className={`p-4 rounded-2xl ${type === "video" ? "bg-purple-500/10" : "bg-blue-500/10"} 
          ...
          <p className="text-xs text-shell-text-muted uppercase tracking-widest">
            {type} media ({mimeType})
          </p>
        </div>
        ...
        {/* The Native Player */}
        <div
          className={`w-full rounded-2xl overflow-hidden glass shadow-2xl border border-white/5 

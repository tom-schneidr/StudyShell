...
- **Documentation**: internal roadmap replaced with current HTML roadmap and architecture docs.
- **Rust verification**: local Rust checks use `scratch/cargo-target` to avoid stale Windows locks in the default Tauri target directory.

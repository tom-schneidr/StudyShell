            ...
            >
              {filteredCommands.length > 0 ? (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between">
                        <span className={`text-[14px] font-medium ${index === selectedIndex ? "text-shell-text" : "text-shell-text-secondary"}`}>
                          {cmd.label}
                        </span>
                        {cmd.shortcut && (
                ...
                <div className="py-12 text-center">
                  ...
                  <p className="text-[13px] text-shell-text-muted">No commands found for "{query}"</p>
                </div>
              )}
            </div>
            ...
            <div className="px-4 py-2 bg-shell-bg/40 border-t border-shell-border flex items-center justify-between">
               <div className="flex items-center gap-4 text-[10px] text-shell-text-muted font-bold uppercase tracking-wider">
                  <div className="flex items-center gap-1.5">
                    <span className="px-1.5 py-0.5 rounded bg-shell-surface border border-shell-border">Enter</span>
                    <span>to select</span>
                  </div>
                  <div className="flex items-center gap-1.5">
